...
1. Performance/resource usage/stats comparison:
   ...
   6. To cleanup run `stats_cleanup.ps1`
2. Queue integration example:
   ...
   7. To cleanup run `queue_cleanup.ps1`
...
dotnet publish Blazor.csproj -c release -r win-x64 --self-contained /p:PublishTrimmed=true /p:PublishReadyToRun=true /p:PublishSingleFile=true
